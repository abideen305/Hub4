...
import { Play, Clock, Users, Book } from 'lucide-react';
...
export default function Animation() {
  ...
  const course = courseDetails['animation'];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <button
                ...
                className="bg-white text-purple-900 px-8 py-3 rounded-lg text-lg font-semibold hover:bg-purple-50 transition duration-300"
              >
                Enroll Now
              </button>
            </div>
            <div className="flex justify-center">
              <Play className="w-48 h-48 text-purple-200" />
            </div>
          </div>
        </div>
      </section>
