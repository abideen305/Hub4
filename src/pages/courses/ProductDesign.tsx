...
import { Palette, Clock, Users, Book } from 'lucide-react';
...
export default function ProductDesign() {
  ...
  const course = courseDetails['product-design'];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <button
                ...
                className="bg-white text-pink-900 px-8 py-3 rounded-lg text-lg font-semibold hover:bg-pink-50 transition duration-300"
              >
                Enroll Now
              </button>
            </div>
            <div className="flex justify-center">
              <Palette className="w-48 h-48 text-pink-200" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <Book className="w-12 h-12 text-pink-600 mb-4" />
