...
import { Database, Clock, Users, Book } from 'lucide-react';
...
export default function DataEngineering() {
  ...
  const course = courseDetails['data-engineering'];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <button
                ...
                className="bg-white text-blue-900 px-8 py-3 rounded-lg text-lg font-semibold hover:bg-blue-50 transition duration-300"
              >
                Enroll Now
              </button>
            </div>
            <div className="flex justify-center">
              <Database className="w-48 h-48 text-blue-200" />
            </div>
          </div>
        </div>
      </section>
